...
from oasisagent import bunch
from oasisagent.common import config
from oasisagent.common import messaging
from oasisagent import exceptions as exc
from oasisagent import execution_plan_queue
from oasisagent import execution_plan_runner
from oasisagent import execution_result as ex_result
...
class OasisAgent(service.Service):
    def __init__(self):
        self._queue = execution_plan_queue.ExecutionPlanQueue()
        super(OasisAgent, self).__init__()
