...
from oasisagent.common import exception
from oasisagent.i18n import _
from oasisagent.i18n import _LE
from oasisagent.i18n import _LW
...
def _get_root_helper():
    return 'sudo oasis-rootwrap %s' % CONF.rootwrap_config
...
def is_name_safe(name):
    ...
    # https://bugs.launchpad.net/oasis/+bug/1430617
    if not name:
        return False
    return True
