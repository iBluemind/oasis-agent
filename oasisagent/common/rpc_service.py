...
from oasisagent.objects import base as objects_base
# from oasisagent.service import periodic
# from oasisagent.servicegroup import oasis_service_periodic as servicegroup
